...
class MainWindow(QMainWindow):
    def __init__(self, initial_file=None):
        ...
        # --- START MODIFICATION FOR LINUX ICON ---
        # Changed icon.ico to icon.png for better cross-platform compatibility.
        # You will need to provide an 'icon.png' file in the same directory as your script.
...
# Proper insert_link implementation
    ...
    def _create_editor_instance(self):
        ...
        # --- START MODIFICATION FOR LINUX FONT ---
        # Changed "Fira Code" to "monospace" for better cross-platform font availability.
        # "monospace" is a generic alias that should map to a suitable monospace font on most systems.
        editor.setFont(QFont("monospace", DEFAULT_FONT_SIZE))
        # --- END MODIFICATION ---
    ...
    def reset_zoom(self):
        if self.current_editor:
            # --- START MODIFICATION FOR LINUX FONT ---
            # Changed "Fira Code" to "monospace" for consistency.
            self.current_editor.setFont(QFont("monospace", DEFAULT_FONT_SIZE))
            # --- END MODIFICATION ---
    ...
    def set_theme(self, mode):
        # --- START MODIFICATION FOR LINUX PATH SEPARATOR ---
        # Replaced os.path.join with f-string and forward slashes for closebutton.png
        # This ensures the path is correctly interpreted in CSS on Linux.
        close_icon_path = f"file:///{resource_path('closebutton.png').replace(os.sep, '/')}"
        # --- END MODIFICATION ---
        dark_theme = f"""
            QMainWindow {{
